...
const numberVar: number = 3; // 여기서 볼 수 있는 규칙: 소문자
...
let anyType2: any = unknownType; // unknown 타입은 any 타입이나 unknown 타입이 아닌 다른 타입에는 할당할 수 없음
 ...
 * 리스트 타입
 */
const suhoList : string[] = ['이수호', '김수호', '박수호']; // 리스트에 타입을 정하고 싶으면 타입 뒤에 []를 붙여줘야함
